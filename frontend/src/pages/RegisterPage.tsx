      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in">
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/50 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 mt-2">{t('welcomeRegister')}</p>
          </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-200 bg-white/50"
